    ...
    <div class="container">
        <div class="row gy-3 gx-3">
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                ...
                <div class="sub-container-box pt-3 pb-1 mt-3">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <div class="sub-container-box pt-4 pb-5">
                    <h4 class="color-pup">PUP TEN PILLARS</h4>
                    <div class="row justify-content-center">
                        <div class="col-11">
                            <p class="my-3"><b>Pillar 1: </b>Dynamic, Transformational, and Responsible Leadership</p>
                            <p class="my-3"><b>Pillar 2: </b>Responsive and Innovative Curricula and Instruction</p>
                            <p class="my-3"><b>Pillar 3: </b>Enabling and Productive Learning Environment</p>
                            <p class="my-3"><b>Pillar 4: </b>Holistic Student Development and Engagement</p>
                            <p class="my-3"><b>Pillar 5: </b>Empowered Faculty Members and Employees</p>
                            <p class="my-3"><b>Pillar 6: </b>Vigorous Research Production and Utilization</p>
                            <p class="my-3"><b>Pillar 7: </b>Global Academic Standards and Excellence</p>
                            <p class="my-3"><b>Pillar 8: </b>Synergistic, Productive, Strategic Networks and Partnerships</p>
                            <p class="my-3"><b>Pillar 9: </b>Active and Sustained Stakeholders' Engagement</p>
                            <p class="my-3"><b>Pillar 10: </b>Sustainable Social Development Programs and Projects</p>
                        </div>
                    </div>
